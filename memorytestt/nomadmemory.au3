...
Func SetPrivilege( $privilege, $bEnable )
    ...
    Const $NomadTOKEN_ADJUST_PRIVILEGES = 0x0020
    Const $NomadTOKEN_QUERY = 0x0008
    Const $NomadSE_PRIVILEGE_ENABLED = 0x0002
    ...
    $SP_auxret = DLLCall("advapi32.dll","int","OpenProcessToken","hwnd",$hCurrProcess[0],   _
            "int",BitOR($NomadTOKEN_ADJUST_PRIVILEGES,$NomadTOKEN_QUERY),"int_ptr",0)
    If $SP_auxret[0] Then
        $hToken = $SP_auxret[3]
        ...
        While $nTokenIndex <= $nTokens
            ...
            If $ret[0] Then
                If $bEnable Then
                    DLLStructSetData($TOKEN_PRIVILEGES,2,$NomadSE_PRIVILEGE_ENABLED,(3 * $nTokenIndex))
                Else
